...
namespace UserManagement.MVC.Models
{
    public class SearchesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SearchId,Title,Author,FileId,DateUploaded,Action,Rating")] Search search)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SearchId,Title,Author,FileId,DateUploaded,Action,Rating")] Search search)
        {
