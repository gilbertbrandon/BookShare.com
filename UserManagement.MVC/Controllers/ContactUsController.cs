...
namespace UserManagement.MVC.Models
{
    public class ContactUsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,FullName,Email,Comments")] ContactUs contactUs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FullName,Email,Comments")] ContactUs contactUs)
        {
            if (id != contactUs.ID)
            {
                return NotFound();
